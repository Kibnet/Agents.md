...
- Evidence inspected: [локальный отчёт](C:/Users/Kibnet/AppData/Local/Temp/agents-astra-8d4b7a25d8504719840465335062d210/REPORT.md); `before-after-evaluation.json`, `provenance-verification.json`, `manual-assessments.json`, per-case `input.txt`/`result.json`/`events.json`, `activation-manifest.json`, `activation-result.json`.
- Depth checklist:
