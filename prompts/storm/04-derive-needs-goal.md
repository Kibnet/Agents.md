...
3. Сгруппируй похожие needs, сохрани связи с исходными stories/constraints и подтверждающими Rule/Scenario examples; не меняй смысл existing scenarios ради группировки.
