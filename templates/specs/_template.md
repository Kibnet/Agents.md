...
- Для model/prompt/instruction migration: обязательный before/after behavioral smoke на одинаковой effective model/surface конфигурации; static lint не заменяет проверку поведения
